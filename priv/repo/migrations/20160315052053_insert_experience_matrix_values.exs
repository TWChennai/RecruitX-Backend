defmodule RecruitxBackend.Repo.Migrations.InsertExperienceMatrixValues do
  ...
  def change do
    ...
    %{"panelist_experience_lower_bound" => 3,"candidate_experience_upper_bound" => 8, "interview_type" => InterviewType.technical_1},
    %{"panelist_experience_lower_bound" => 3,"candidate_experience_upper_bound" => 8, "interview_type" => InterviewType.technical_2},
    %{"panelist_experience_lower_bound" => 5,"candidate_experience_upper_bound" => 8, "interview_type" => InterviewType.coding},
    %{"panelist_experience_lower_bound" => 5,"candidate_experience_upper_bound" => 12, "interview_type" => InterviewType.technical_1},
    %{"panelist_experience_lower_bound" => 5,"candidate_experience_upper_bound" => 12, "interview_type" => InterviewType.technical_2},
    %{"panelist_experience_lower_bound" => 8,"candidate_experience_upper_bound" => 12, "interview_type" => InterviewType.coding},
    %{"panelist_experience_lower_bound" => 8,"candidate_experience_upper_bound" => 99, "interview_type" => InterviewType.technical_1},
    %{"panelist_experience_lower_bound" => 8,"candidate_experience_upper_bound" => 99, "interview_type" => InterviewType.technical_2}],
