defmodule RecruitxBackend.JigsawController do
  ...
  def show(conn, %{"id" => id}) do
    user_details = case id do
      "ppanelist" -> %{is_recruiter: false, calculated_hire_date: Date.now |> Date.shift(months: -10), past_experience: 0.24}
      "ppanelistp" -> %{is_recruiter: false, calculated_hire_date: Date.now |> Date.shift(months: -100), past_experience: 0.24}
      "rrecruitx" -> %{is_recruiter: true, calculated_hire_date: Date.now |> Date.shift(months: -10), past_experience: 0.24}
      "rrecruitxr" -> %{is_recruiter: true, calculated_hire_date: Date.now |> Date.shift(months: -100), past_experience: 0.24}
