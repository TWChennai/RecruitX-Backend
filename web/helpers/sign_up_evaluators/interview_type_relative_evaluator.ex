defmodule RecruitxBackend.InterviewTypeRelativeEvaluator do
  ...
  def evaluate(sign_up_evaluation_status, interview_type_specfic_criteria, panelist_login_name, panelist_role, interview) do
    ...
    |> is_eligible_to_take_based_on_interview_type(interview_type_specfic_criteria, panelist_login_name, panelist_role, interview)
  end

  defp is_eligible_to_take_based_on_interview_type(sign_up_evaluation_status, %{valid?: false}, _, _, _, _), do: sign_up_evaluation_status

  defp is_eligible_to_take_based_on_interview_type(sign_up_evaluation_status, interview_type_specfic_criteria, panelist_login_name, panelist_role, interview) do
    is_interview_type_limited = is_interview_type_with_specific_panelists(interview, interview_type_specfic_criteria)
    if (is_interview_type_limited and !is_allowed_panelist(interview, interview_type_specfic_criteria, panelist_login_name))
    or (!is_interview_type_limited and panelist_role |> is_nil) do
