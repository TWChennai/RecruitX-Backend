defmodule RecruitxBackend.SignUpEvaluator do
  ...
  def evaluate(sign_up_data_container, interview) do
    ...
    |> is_valid_against_experience_matrix(sign_up_data_container.panelist_experience, interview.candidate.experience, interview.interview_type_id)
  end
  ...
  defp is_valid_against_experience_matrix(sign_up_evaluation_status, panelist_experience, candidate_experience, interview_type_id) do
    if sign_up_evaluation_status.valid? and !ExperienceMatrix.is_eligible(panelist_experience, candidate_experience, interview_type_id) do
