defmodule MailmanExtensions.Templates do
  ...
  EEx.function_from_file(:def, :panelist_removal_notification, "web/templates/mail/panelist_removal_notification.html.eex", [:candidate_first_name, :candidate_last_name, :interview_name])
end
