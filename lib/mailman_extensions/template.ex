defmodule MailmanExtensions.Templates do
  ...
  EEx.function_from_file(:def, :weekly_status_update, "web/templates/mail/weekly_status_update.html.eex", [:start_date, :to_date, :candidates, :candidates_appeared, :interviews_count])
