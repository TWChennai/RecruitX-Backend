defmodule RecruitxBackend.InterviewSpec do
  ...
  context "valid changeset" do
    ...
    it "should be valid when name has numbers in it" do
      interview_with_numbers = Dict.merge(valid_attrs, %{name: "P3"})
  ...
  context "invalid changeset" do
    ...
    it "should be invalid when name is a blank string" do
      interview_with_blank_name = Dict.merge(valid_attrs, %{name: "  "})
    ...
    it "should be invalid when name is only numbers" do
      interview_with_numbers_name = Dict.merge(valid_attrs, %{name: "678"})
    ...
    it "should be invalid when name begins with numbers" do
      interview_beginning_with_numbers_name = Dict.merge(valid_attrs, %{name: "678AB"})
    ...
    it "should be invalid when name starts with space" do
      interview_starting_with_space_name = Dict.merge(valid_attrs, %{name: " space"})
