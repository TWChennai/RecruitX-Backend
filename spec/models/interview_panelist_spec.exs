defmodule RecruitxBackend.InterviewPanelistSpec do
  ...
  let :valid_attrs, do: params_with_assocs(:interview_panelist)
  ...
  context "invalid changeset" do
    ...
    it do: should have_errors([panelist_login_name: {"can't be blank", [validation: :required]}, interview_id: {"can't be blank", [validation: :required]}])
    ...
    it "should be invalid when panelist_login_name is an empty string" do
      ...
      expect(changeset) |> to(have_errors([panelist_login_name: {"can't be blank", [validation: :required]}]))
    end
    ...
    it "should be invalid when panelist_login_name is a blank string" do
      ...
      expect(changeset) |> to(have_errors([panelist_login_name: {"has invalid format", [validation: :format]}]))
    end
  ...
  describe "query" do
    ...
    context "get_interviews_signed_up_by" do
      it "should give the interviews for the requested panelist" do
        ...
        interview_panelist = insert(:interview_panelist, panelist_login_name: panelist_login_name)
