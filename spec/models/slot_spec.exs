defmodule RecruitxBackend.SlotSpec do
  ...
  context "valid changeset" do
    ...
    it "pre populate avg experience and skills of a candidate scheduled on the day" do
      Repo.delete_all(Interview)
      experience =  Decimal.new(1.0)
      candidate = create(:candidate, experience: experience)
    ...
    it "pre populate avg experience and skills of all candidates scheduled on the day" do
      Repo.delete_all(Interview)
      experience =  Decimal.new(1.0)
      candidate1 = create(:candidate, experience: experience)
      candidate2 = create(:candidate, experience: experience)
      create(:interview, start_time: get_start_of_next_week , interview_type_id: create(:interview_type, priority: 1).id, candidate_id: candidate1.id)
